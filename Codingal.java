...
int lengthOfCodingalTrick=codingalTrick.length();int sum=lengthOfCodingal+lengthOfCodingalTrick;

//Guess the answer before running
//a msg can also be added for the output screen is required
