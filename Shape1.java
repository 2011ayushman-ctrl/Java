...
class Triangle extends Shape{ //extend form the Shape class
    private double base;
    ...
    public double getArea() {//area of triangle 1/2*b*h //area using heron's formula can also be used here
